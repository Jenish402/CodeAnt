...
//   return (
//     <div className="sidebar-container md:w-[254px] md:border-r w-full border-none font-inter">
...
//           <ul className="mt-auto flex flex-col gap-y-[10px] absolute bottom-[0px] md:bottom-[20px] text-nowrap font-semibold">{renderLinks(linksArray[1])}</ul>
//         </div>
//       </div>
//     </div>
//   );
...
function Sidebar() {
  ...
  return (
    ...
    //       onClick={() => setMenuToggal(false)} // Close toggle on clicking the overlay
    //     ></div>
    //   )}
      
    //   <div className="sub-sidebar-container flex flex-col sm:items-center items-start w-full relative z-50">
    //     <div className="flex items-center justify-between w-full p-[20px]">
    //       <img className="w-[161px]" src={Logo} alt="Logo" />
    //       <button
    //         className="text-2xl md:hidden"
  ...
  {menuToggal && (
    <div
      className="fixed top-[100px] inset-0 bg-gray-500 opacity-50 z-50"
      onClick={() => setMenuToggal(false)} // Close toggle on clicking the overlay
    ></div>
  )}
  ...
  <div className="sub-sidebar-container flex flex-col sm:items-center items-start w-full relative z-50">
    ...
    >
      ...
      <ul className="text-nowrap flex flex-col gap-y-[10px] font-semibold">{renderLinks(linksArray[0])}</ul>
      <ul className="absolute bottom-[-290px] text-nowrap font-semibold">{renderLinks(linksArray[1])}</ul>
    </div>
  </div>
</div>
